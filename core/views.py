...
# =========================
# Helpers organización / roles
# =========================

def _user_org_or_none(user):
    """
    Devuelve la organización del usuario (si tiene Account).
    - Superuser puede no tener organización => retorna None (ve todo).
    """
    if user.is_superuser:
        # Si el superuser tiene Account con organización, la usamos; si no, None
